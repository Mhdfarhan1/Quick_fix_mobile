...
class ElectronicsCategoryScreen extends StatefulWidget {
  ...
  @override
  State<ElectronicsCategoryScreen> createState() => _ElectronicsCategoryScreenState();
}
...
class _ElectronicsCategoryScreenState extends State<ElectronicsCategoryScreen> {
  ...
  void initState() {
    ...
    // Search for "Elektronik" match
    _servicesFuture = _fetchServicesForCategory("Elektronik");
  }
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildServicesHeader("Layanan Elektronik"),
            _buildServices(),
